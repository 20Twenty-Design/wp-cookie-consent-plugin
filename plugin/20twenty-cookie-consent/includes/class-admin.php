	...
	public function render(): void {
		...
		<div class="wrap">
			...
			<div class="twcc-card">
				...
				<p><?php esc_html_e( 'Front-end package:', '20twenty-cookie-consent' ); ?> <code>@20twenty-design/cookie-consent</code> — <a href="https://github.com/20Twenty-Design/wp-cookie-consent-plugin#readme" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'setup guide', '20twenty-cookie-consent' ); ?></a></p>
			</div>
