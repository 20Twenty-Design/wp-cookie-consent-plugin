...
* Headless: settings at `/wp-json/20twenty-cookie-consent/v1/settings` and the WPGraphQL `cookieConsentSettings` field, consumed by the `@20twenty-design/cookie-consent` npm package.
